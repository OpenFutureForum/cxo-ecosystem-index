...
export function buildKnowledgeGraph(entities,relationships,sources){
 ...
 return {schema_version:RELATIONSHIP_SCHEMA_VERSION,dataset_version:'0.9.0',generated_at:'2026-08-11',sourced_relationship_count:relationships.length,derived_reciprocal_count:reciprocal.length,relationships:[...relationships,...reciprocal]};
}
